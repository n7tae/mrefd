...
SRCS = base.cpp bwset.cpp callsign.cpp client.cpp clients.cpp configure.cpp crc.cpp gatekeeper.cpp gnss.cpp interlink.cpp interlinks.cpp ip.cpp packet.cpp packetstream.cpp parrot.cpp peer.cpp peers.cpp protocol.cpp reflector.cpp refmods.cpp udpsocket.cpp user.cpp users.cpp version.cpp main.cpp
