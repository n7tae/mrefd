...
public:
	...
	#ifndef NO_DHT
	void Update(const std::string &cs, const std::string &cmods, const std::string &emods, const std::string &vstr, const std::string &ipv4, const std::string &ipv6, const std::string &url, uint16_t port);
	#endif
...
#endif
	void Emplace(const std::string &cs, const std::string &mods, const std::string &vstr, const std::string &addr, uint16_t port);
